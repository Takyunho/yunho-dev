    ...
    >
      ...
      <ul className="border-b border-line">
        {STACK_CATEGORIES.map((stackCategory) => (
          ...
          >
            <p className="font-mono text-xs tracking-[0.2em] text-muted uppercase md:pt-3">
              {stackCategory.label}
              <span className="ml-2 tracking-normal normal-case">
                {stackCategory.labelKorean}
              </span>
            </p>
            <p className="text-2xl leading-snug font-medium tracking-tight text-fg md:text-4xl">
